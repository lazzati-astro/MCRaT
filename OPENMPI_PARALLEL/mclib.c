...
void dirFileMerge(char dir[200], int start_frame, int last_frame, int numprocs)
{
    //function to merge files in mcdir produced by various threads
    int i=0, j=0, k=0, num_files=8; //number of files is number of types of mcdata files there are
    char filename_k[200],filename_1[200], file_no_thread_num[200], cmd[2000], mcdata_type[200];
